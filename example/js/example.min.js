...
U[P]=!1,U[L]=U[M]=U[N]=U[O]=U[Q]=U[R]=U[S]=U[T]=!0;var V={leading:!1,maxWait:0,trailing:!1},W={configurable:!1,enumerable:!1,value:null,writable:!1},X={"boolean":!1,"function":!0,object:!0,number:!1,string:!1,undefined:!1},Y={"\\":"\\","'":"'","\n":"n","\r":"r","	":"t","\u2028":"u2028","\u2029":"u2029"},Z=X[typeof window]&&window||this,$=X[typeof c]&&c&&!c.nodeType&&c,_=X[typeof b]&&b&&!b.nodeType&&b,ab=_&&_.exports===$&&$,bb=X[typeof a]&&a;!bb||bb.global!==bb&&bb.window!==bb||(Z=bb);var cb=p();"function"==typeof define&&"object"==typeof define.amd&&define.amd?(Z._=cb,define(function(){return cb})):$&&_?ab?(_.exports=cb)._=cb:$._=cb:Z._=cb}).call(this)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],39:[function(a,b,c){arguments[4][24][0].apply(c,arguments)},{dup:24}],40:[function(a,b){"use strict";b.exports=a("./lib/stylie.notifications")},{"./lib/stylie.notifications":41}],41:[function(a,b){"use strict";var c,d,e,f=a("util-extend"),g=a("classie"),h=a("events"),i=a("util"),j=a("detectcss"),k={MozAnimation:"animationend",WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd",animation:"animationend"},l=function(a){h.EventEmitter.call(this),this.options=f(this.options,a),this._init(),this.show=this._show,this.dismiss=this._dismiss};i.inherits(l,h.EventEmitter),l.prototype.options={wrapper:document.querySelector("body"),message:"yo!",layout:"growl",effect:"slide",type:"error",ttl:6e3,onClose:function(){return!1},onOpen:function(){return!1}},l.prototype._init=function(){c=j.prefixed("animation"),d=j.prefixed("perspective"),e=k[j.prefixed("animation")],this.ntf=document.createElement("div"),this.ntf.className="ts-ns-box ts-ns-"+this.options.layout+" ts-ns-effect-"+this.options.effect+" ts-ns-type-"+this.options.type;var a='<div class="ts-ns-box-inner">';a+=this.options.message,a+="</div>",a+='<span class="ts-ns-close"></span></div>',this.ntf.innerHTML=a,this.options.wrapper=this.options.wrapper?this.options.wrapper:document.querySelector("body"),this.options.wrapper.insertBefore(this.ntf,this.options.wrapper.firstChild);var b=this;this.dismissttl=this.options.ttl?setTimeout(function(){b.active&&b.dismiss()},this.options.ttl):!1,this._initEvents(),this.emit("notificationsInitialized")},l.prototype._initEvents=function(){var a=this;this.ntf.querySelector(".ts-ns-close").addEventListener("click",function(){a.dismiss()}),this.emit("notificationsEventsInitialized")},l.prototype._dismiss=function(){var a=this;this.active=!1,this.options.ttl&&clearTimeout(this.dismissttl),g.remove(this.ntf,"ts-ns-show"),setTimeout(function(){g.add(a.ntf,"ts-ns-hide"),a.options.onClose()},25);var b=function(d){if(c){if(d.target!==a.ntf)return!1;this.removeEventListener(e,b)}a.options.wrapper.removeChild(this)};c?this.ntf.addEventListener(e,b):b(),this.emit("dismissNotification",this.ntf)},l.prototype._show=function(){this.active=!0,g.remove(this.ntf,"ts-ns-hide"),g.add(this.ntf,"ts-ns-show"),this.options.onOpen(),this.emit("showNotification",this.ntf)},b.exports=l},{classie:6,detectcss:8,events:18,util:23,"util-extend":42}],42:[function(a,b,c){arguments[4][5][0].apply(c,arguments)},{dup:5}],43:[function(a){"use strict";var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r=0,s=a("bindie"),t=a("classie"),u=a("ejs"),v=a("forbject"),w=a("moment"),x=a("nach"),y=a("filesaver.js"),z=a("stylie.notifications"),A=x.Utils;u.delimiter="?";var B=function(a){o=new z({wrapper:document.querySelector("#ach"),message:a.type+": "+a.message,ttl:6e3,layout:"growl",effect:"jelly",type:"notice"}),o.show()},C=function(){var a=new Blob([f.innerHTML],{type:"text/plain;charset=utf-8"});y(a,"nACHa.txt"),B({type:"File Saved",message:"nACHa file saved"})},D=function(){console.log("achFile",e);var a=new Blob([JSON.stringify(e,null,"  ")],{type:"application/json;charset=utf-8"});y(a,"nachie.json"),B({type:"File Saved",message:"Nachie file saved"})},E=function(){if(t.has(p,"showing-optional")){t.remove(p,"showing-optional"),p.innerHTML="show optional";for(var a=0;a<q.length;a++)t.remove(q[a],"ts-show-optional")}else{t.add(p,"showing-optional"),p.innerHTML="hide optional";for(var b=0;b<q.length;b++)t.add(q[b],"ts-show-optional")}},F=function(){t.has(k,"expanded")?(t.remove(k,"expanded"),i.innerHTML="expand"):(t.add(k,"expanded"),i.innerHTML="collapse")},G=function(){g.refresh(),d.update({data:{achBatchCount:{batchIndex:r,forbjectData:{formdata:g.getObject()}}}}),g.refresh(),r++},H=function(a){try{a.generateFile(function(a){f.innerHTML=a})}catch(b){B(b),console.error(b)}},I=function(a){try{if(e=new x.File(a.file),a.batches)for(var b in a.batches){if(a.batches[b].effectiveEntryDate=w(a.batches[b].effectiveEntryDate,"YYMMDD").toDate(),m=new x.Batch(a.batches[b]),a.batches[b].entries)for(var c in a.batches[b].entries)n=new x.Entry(a.batches[b].entries[c]),m.addEntry(n);e.addBatch(m)}H()}catch(d){B(d),console.error(d)}},J=function(){document.querySelector("#fileCreationDate").value=A.formatDate(new Date),document.querySelector("#fileCreationTime").value=A.formatTime(new Date)},K=function(){q=document.querySelectorAll(".ts-form-optional")},L=function(a){var c,d,e,f,i,j=a.target,k=document.createElement("section");t.has(j,"remove-batch-button")?(c=j.getAttribute("data-batchIndex"),b.removeChild(document.querySelector("#ach-batch-"+c)),r--,g.refresh()):t.has(j,"remove-batchentry-button")?(c=j.getAttribute("data-batchIndex"),d=j.getAttribute("data-entryIndex"),document.querySelector("#ach-batch-entrycontainer-"+c).removeChild(document.querySelector("#ach-batchentry-"+c+"-"+d)),g.refresh()):t.has(j,"add-batch-entry-button")&&(c=j.getAttribute("data-batchIndex"),f=document.querySelector("#ach-batch-"+c),i=f.querySelectorAll(".ach-batchentry"),d=i.length,console.log("entryIndex",d),console.log("elementsInBatch",i),console.log("elementsInBatch.length",i.length),e=u.render(h,{batchIndex:c,entryIndex:d,entriesCount:i.length+1,forbjectData:{formdata:g.getObject()}}),k.setAttribute("class","ach-batchentry ts-form-row"),k.setAttribute("id","ach-batchentry-"+c+"-"+d),k.setAttribute("data-batchIndex",c),k.setAttribute("data-entryIndex",d),k.innerHTML=e,document.querySelector("#ach-batch-entrycontainer-"+c).innerHTML='<section class="ach-batchentry ts-form-row" id="ach-batchentry-'+c+"-"+d+'" data-batchindex="'+c+'" data-entryindex="'+d+'">'+e+"</section>",g.refresh())},M=function(){window.scrollY>l&&!t.has(k,"ach-fix-top")?t.add(k,"ach-fix-top"):window.scrollY<l&&t.has(k,"ach-fix-top")&&t.remove(k,"ach-fix-top")},N=function(a){var b={},c=function(a){var b={};for(var c in a.fields)b[c]=a.fields[c].value;return b},d=function(a){var b={};for(var d in a.header)b[d]=a.header[d].value;if(a._entries.length>0){b.entries=[];for(var e=0;e<a._entries.length;e++)b.entries[e]=c(a._entries[e])}return b};try{for(var f in a.header)b[f]=a.header[f].value;if(e=new x.File(b),a._batches)for(var g=0;g<a._batches.length;g++){if(a._batches[g]=d(a._batches[g]),a._batches[g].effectiveEntryDate=w(a._batches[g].effectiveEntryDate,"YYMMDD").toDate(),m=new x.Batch(a._batches[g]),console.log("newACHBatch",m),a._batches[g].entries)for(var h in a._batches[g].entries)n=new x.Entry(a._batches[g].entries[h]),console.log("newACHEntry",n),m.addEntry(n);e.addBatch(m)}H(e)}catch(i){B(i),console.error(i)}},O=function(){var a,b=j.files[0],c=new FileReader;c.readAsText(b),c.onload=function(){try{a=JSON.parse(c.result),N(a),B({type:"File Loaded",message:"nACHa file loaded"})}catch(b){B(b),console.error(b)}}};window.addEventListener("load",function(){d=new s({ejsdelimiter:"?",strictbinding:!0}),d.addBinder({prop:"achBatchCount",elementSelector:"#ach-file-batches",binderType:"template",binderTemplate:document.querySelector("#ach-batch-template").innerHTML,binderCallback:function(){K(),g.refresh()}}),f=document.querySelector("#ach-file-output"),g=new v("#ach",{autorefresh:!0,valuefilter:function(a){return"string"==typeof a?a.toUpperCase():a}}),g.on("autoRefreshOnValChange",I),c=document.querySelector("#add-batch-button"),c.addEventListener("click",G,!1),b=document.querySelector("#ach-file-batches"),b.addEventListener("click",L,!1),h=document.querySelector("#ach-batch-entrytemplate").innerHTML,i=document.querySelector("#expand-button"),i.addEventListener("click",F,!1),j=document.querySelector("#load-button"),j.addEventListener("change",O,!1),p=document.querySelector("#optional-button"),p.addEventListener("click",E,!1),q=document.querySelectorAll(".ts-form-optional"),k=document.querySelector("#ts-ach-file-container"),l=k.getBoundingClientRect().top,J(),document.querySelector("#download-button").addEventListener("click",C,!1),document.querySelector("#save-button").addEventListener("click",D,!1),window.achForbject=g,window.achFile=e,window.addEventListener("scroll",M,!1)},!1)},{bindie:1,classie:6,ejs:10,"filesaver.js":13,forbject:14,moment:24,nach:25,"stylie.notifications":40}]},{},[43]);
